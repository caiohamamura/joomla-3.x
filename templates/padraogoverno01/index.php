...
?>
<!DOCTYPE html>
<!--[if lt IE 71]>      <html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="pt-br" dir="ltr"> <![endif]-->
...
<head>
	...
	<link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/css/template-<?php echo $this->params->get('cor', 'verde'); ?>.css?v=f" type='text/css'/>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-176826559-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  
  gtag('config', 'UA-176826559-1');
  </script>
</head>
        ...
        <main>
            <div class="container">
                ...
                <div class="row-fluid">
                    ...
                    <a href="/index.php/espaco-do-servidor" class="visible-phone visible-tablet btn"><i class="icon-user"><br/></i>Servidor</a>
                    <a href="/index.php/espaco-do-estudante" class="visible-phone visible-tablet btn"><i class="icon-pencil"><br/></i>Aluno</a>
                        <a href="#" class="visible-phone visible-tablet mainmenu-toggle btn"><i class="icon-list"><br/></i>Menu</a>
...
?>
  ...
  <script src="/templates/padraogoverno01/js/spoiler.js?v=7" type="text/javascript"></script>
</body>
</html>

<?php
$doc = JFactory::getDocument();
$doc->addFavicon("/images/favicon.ico");
?>
